...
mpi_init_t = 1 + (strong_ext08(2,1) - serial_time_8(1,1))*(1e+08)/( strong_ext08(1,1) )*1./N_vec ;
...
plot(N_vec,mpi_init_t,'LineWidth',1.5);
...
legend('Parallel (internal)','Total (elapsed)','Location','northwest');
...
legend('Parallel (internal) t','Total (elapsed) t','Location','northwest');
...
errorbar(cores,int_scaling_strong08(:,1),int_scaling_strong08(:,2),'*','LineStyle','-','LineWidth',1.5,'MarkerSize',3);
errorbar(cores,int_scaling_strong09(:,1),int_scaling_strong09(:,2),'*','LineStyle','-','LineWidth',1.5,'MarkerSize',3);
errorbar(cores,int_scaling_strong10(:,1),int_scaling_strong10(:,2),'*','LineStyle','-','LineWidth',1.5,'MarkerSize',3);
errorbar(cores,int_scaling_strong11(:,1),int_scaling_strong11(:,2),'*','LineStyle','-','LineWidth',1.5,'MarkerSize',3);
legend('N=10-08','N=10-09','N=10-10','N=10-11','Location','northwest');
...
errorbar(cores,ext_scaling_strong08(:,1),ext_scaling_strong08(:,2),'*','LineStyle','-','LineWidth',1.5,'MarkerSize',3);
errorbar(cores,ext_scaling_strong09(:,1),ext_scaling_strong09(:,2),'*','LineStyle','-','LineWidth',1.5,'MarkerSize',3);
errorbar(cores,ext_scaling_strong10(:,1),ext_scaling_strong10(:,2),'*','LineStyle','-','LineWidth',1.5,'MarkerSize',3);
errorbar(cores,ext_scaling_strong11(:,1),ext_scaling_strong11(:,2),'*','LineStyle','-','LineWidth',1.5,'MarkerSize',3);
...
fit_over_8 = parallel_fit(cores,[serial_coef(2);params(:,1)], 1e08  );
fit_over_9 = parallel_fit(cores,[serial_coef(2);params(:,2)], 1e09  );
fit_over_10 = parallel_fit(cores,[serial_coef(2);params(:,3)], 1e10  );
fit_over_11 = parallel_fit(cores,[serial_coef(2);params(:,4)], 1e11  );
...
grid on
plot(cores,ones(length(cores),1),'k','HandleVisibility','off');
errorbar(cores,T_over_8(:,1),T_over_8(:,2),'*','LineStyle','-','Color','k','LineWidth',1.2,'MarkerSize',3,'HandleVisibility','off');
errorbar(cores,T_over_9(:,1),T_over_9(:,2),'*','LineStyle','-','Color','k','LineWidth',1.2,'MarkerSize',3,'HandleVisibility','off');
errorbar(cores,T_over_10(:,1),T_over_10(:,2),'*','LineStyle','-','Color','k','LineWidth',1.2,'MarkerSize',3,'HandleVisibility','off');
errorbar(cores,T_over_11(:,1),T_over_11(:,2),'*','LineStyle','-','Color','k','LineWidth',1.2,'MarkerSize',3,'HandleVisibility','off');



plot(cores,fit_over_8,'LineWidth',1.8);
plot(cores,fit_over_9,'LineWidth',1.8);
plot(cores,fit_over_10,'LineWidth',1.8);
plot(cores,fit_over_11,'LineWidth',1.8);
legend('N=10-08','N=10-09','N=10-10','N=10-11','Location','northwest');
...
function [scaling_out] = th_scaling_nocomm(cores,params,p,N)
   ...
   scaling_out = (p*N)./( (p*N).*cores_inv + (k1 ).*cores );
    %scaling_out=transpose(scaling_out);
...
function [scaling_out] = th_scaling_comm(cores,params,p,N)
    ...
    scaling_out = (p*N)./( (p*N).*cores_inv + (k1 + k2).*cores );
    %scaling_out=transpose(scaling_out);
...
function [over] = parallel_fit(cores,params,N)
   ...
   over =  1 - 1./( cores.*cores.*((k1 + k2)/(p*N)) + 1  );
